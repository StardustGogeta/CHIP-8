...
$(OBJDIR_DEBUG)/opcode.o: opcode.c
	$(CC) $(CFLAGS_DEBUG) $(INC_DEBUG) -c opcode.c -o $(OBJDIR_DEBUG)/opcode.o
...
$(OBJDIR_RELEASE)/opcode.o: opcode.c
	$(CC) $(CFLAGS_RELEASE) $(INC_RELEASE) -c opcode.c -o $(OBJDIR_RELEASE)/opcode.o
